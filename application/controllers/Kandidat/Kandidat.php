<?php
require APPPATH. '/controllers/Kandidat/Kandidat_config.php';
...
class Kandidat extends CI_Controller {
   ...
   function __construct(){
        parent::__construct();
		$this->load->model('Kandidat/Kandidat_model','tmodel');
		$this->log_key ='log_Kandidat';
		$this->title = new Kandidat_config();
   }
	...
	public function index(){
		$data = array(
			...
			'title'					=> $this->title,
			'link_refresh_table'	=> site_url().'Kandidat/Kandidat/refresh_table/'.$this->_token,
			'link_create'			=> site_url().'Kandidat/Kandidat/create',
			'link_update'			=> site_url().'Kandidat/Kandidat/update',
			'link_delete'			=> site_url().'Kandidat/Kandidat/delete_multiple',
		);
		
		$this->template->load('Kandidat/Kandidat_list',$data);
	}
	...
	public function create(){
		$data = array(
			...
			'title'					=> $this->title,
			'link_save'				=> site_url().'Kandidat/Kandidat/create_action',
			'link_back'				=> $this->agent->referrer(),			
		);
		
		$this->template->load('Kandidat/Kandidat_form',$data);
		...
		**/
		...
		if($row){
			$data = array(
				'title_page_big'		=> 'Buat Baru',
				'title'					=> $this->title,
				'link_save'				=> site_url().'Kandidat/Kandidat/update_action',
				'link_back'				=> $this->agent->referrer(),
				'data'					=> $row,
				'id'					=> $id_generate,
			);
